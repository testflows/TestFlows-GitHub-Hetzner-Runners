...
ACTIONS_RUNNER_SHA256="9b1dc70626422526e3c94767cf024896beb15da5342a3f4819bf2feac13e0393"
...
# Use SERVER_NAME if provided (required for recycle_without_rebuild), fall back to hostname
RUNNER_NAME="${SERVER_NAME:-$(hostname)}-${SERVER_TYPE_NAME}-${SERVER_LOCATION_NAME}"
