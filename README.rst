...
.. image:: https://img.shields.io/github/v/release/testflows/runners
   :target: https://github.com/testflows/runners/releases
   :alt: Latest Release

.. image:: https://img.shields.io/github/contributors/testflows/runners
   :target: https://github.com/testflows/runners/graphs/contributors
   :alt: Contributors

.. image:: https://img.shields.io/github/issues/testflows/runners
   :target: https://github.com/testflows/runners/issues
   :alt: Open Issues

.. image:: https://img.shields.io/github/stars/testflows/runners?style=plastic
   :target: https://github.com/testflows/runners/stargazers
   :alt: GitHub stars
...
:License:
   `Apache-2.0 <https://github.com/testflows/runners/blob/main/LICENSE>`_
...
:🔍 Tip:
   See `Wiki <https://github.com/testflows/runners/wiki>`_ for full documentation.
...
.. image:: https://github.com/testflows/runners/blob/main/docs/images/github_runners.gif
   :align: center
...
:✋ Note:
   ...
   the same way as for a job that takes 59 minutes. Therefore, unless server reuse is enabled using `server recycling <https://github.com/testflows/runners/wiki/Recycling-Powered%E2%80%90Off-Servers>`_, 
...
* `Home <https://github.com/testflows/runners/wiki>`_
* `Installation <https://github.com/testflows/runners/wiki/Installation>`_
* `Quick Start <https://github.com/testflows/runners/wiki/Quick-Start>`_
* `Getting Started Tutorial <https://github.com/testflows/runners/wiki/Getting-Started-Tutorial>`_
* `Basic Configuration <https://github.com/testflows/runners/wiki/Basic-Configuration>`_
* `Specifying the Maximum Number of Runners <https://github.com/testflows/runners/wiki/Specifying-the-Maximum-Number-of-Runners>`_
* `Specifying the Maximum Number of Runners Used in Workflow a Run <https://github.com/testflows/runners/wiki/Specifying-the-Maximum-Number-of-Runners-Used-in-Workflow-a-Run>`_
* `Recycling Powered‐Off Servers <https://github.com/testflows/runners/wiki/Recycling-Powered‐Off-Servers>`_
* `Skipping Jobs <https://github.com/testflows/runners/wiki/Skipping-Jobs>`_
* `Using Custom Label Prefix <https://github.com/testflows/runners/wiki/Using-Custom-Label-Prefix>`_
* `Jobs That Require the Docker Engine <https://github.com/testflows/runners/wiki/Jobs-That-Require-the-Docker-Engine>`_
* `Specifying The Runner Type <https://github.com/testflows/runners/wiki/Specifying-The-Runner-Type>`_
* `Specifying The Runner Location <https://github.com/testflows/runners/wiki/Specifying-The-Runner-Location>`_
* `Specifying The Runner Network <https://github.com/testflows/runners/wiki/Specifying-The-Runner-Network>`_
* `Specifying The Runner Image <https://github.com/testflows/runners/wiki/Specifying-The-Runner-Image>`_
* `Specifying The Custom Runner Server Setup Script <https://github.com/testflows/runners/wiki/Specifying-The-Custom-Runner-Server-Setup-Script>`_
* `Specifying The Custom Runner Server Startup Script <https://github.com/testflows/runners/wiki/Specifying-The-Custom-Runner-Server-Startup-Script>`_
* `Disabling Setup or Startup Scripts <https://github.com/testflows/runners/wiki/Disabling-Setup-Or-Startup-Scripts>`_
* `Specifying Standby Runners <https://github.com/testflows/runners/wiki/Specifying-Standby-Runners>`_
* `Using Caching Volumes <https://github.com/testflows/runners/wiki/Using-Caching-Volumes>`_
* `Specifying Logger Configuration <https://github.com/testflows/runners/wiki/Specifying-Logger-Configuration>`_
* `Listing All Current Servers <https://github.com/testflows/runners/wiki/Listing-All-Current-Servers>`_
* `Opening The SSH Client To The Server <https://github.com/testflows/runners/wiki/Opening-The-SSH-Client-To-The-Server>`_
* `Deleting All Runners and Their Servers <https://github.com/testflows/runners/wiki/Deleting-All-Runners-and-Their-Servers>`_
* `Using a Configuration File <https://github.com/testflows/runners/wiki/Using-a-Configuration-File>`_
* `Using Project Configuration Files <https://github.com/testflows/runners/wiki/Using-Project-Configuration-Files>`_
* `Specifying SSH Key <https://github.com/testflows/runners/wiki/Specifying-SSH-Key>`_
* `Specifying Additional SSH Keys <https://github.com/testflows/runners/wiki/Specifying-Additional-SSH-Keys>`_
* `Running as a Service <https://github.com/testflows/runners/wiki/Running-as-a-Service>`_
* `Running as a Cloud Service <https://github.com/testflows/runners/wiki/Running-as-a-Cloud-Service>`_
* `Scaling Up Runners <https://github.com/testflows/runners/wiki/Scaling-Up-Runners>`_
* `Scaling Down Runners <https://github.com/testflows/runners/wiki/Scaling-Down-Runners>`_
* `Handling Failing Conditions <https://github.com/testflows/runners/wiki/Handling-Failing-Conditions>`_
* `Meta Labels <https://github.com/testflows/runners/wiki/Meta-Labels>`_
* `Estimating Costs <https://github.com/testflows/runners/wiki/Estimating-Costs>`_
* `Listing Images <https://github.com/testflows/runners/wiki/Listing-Images>`_
* `Deleting Images <https://github.com/testflows/runners/wiki/Deleting-Images>`_
* `Creating Custom Images <https://github.com/testflows/runners/wiki/Creating-Custom-Images>`_
* `Embedded Monitoring Dashboard <https://github.com/testflows/runners/wiki/Embedded-Monitoring-Dashboard>`_
* `Prometheus Metrics <https://github.com/testflows/runners/wiki/Prometheus-Metrics>`_
* `Program Options <https://github.com/testflows/runners/wiki/Program-Options>`_
...
❶ Before we get started, you will need to install **testflows.runners** Python package. See the `Installation <https://github.com/testflows/runners/wiki/Installation>`_ section for more details.
...
.. image:: https://raw.githubusercontent.com/testflows/runners/master/docs/images/github_create_repo_and_token.gif
   :align: center
   :width: 790px
...
.. image:: https://raw.githubusercontent.com/testflows/runners/master/docs/images/hetzner_create_project_and_token.gif
   :align: center
   :width: 790px
   :alt: Creating a GitHub Repository and Token
...
See the `Running as a Cloud Service <https://github.com/testflows/runners/wiki/Running-as-a-Cloud-Service>`_ section for details.
...
.. image:: https://raw.githubusercontent.com/testflows/runners/master/docs/images/cloud_deploy.gif
   :align: center
   :width: 625px
...
.. image:: https://raw.githubusercontent.com/testflows/runners/master/docs/images/github_job_completed.gif
   :align: center
   :width: 790px
...
:✋ Note:
   ...
   **github-hetzner-runners cloud log -f** command. For other cloud service commands, see the `Running as a Cloud Service <https://github.com/testflows/runners/wiki/Running-as-a-Cloud-Service>`_ section.
...
Below is a demonstration of the `embedded monitoring dashboard <https://github.com/testflows/runners/wiki/Embedded-Monitoring-Dashboard>`_ in action, monitoring runners for the `altinity/clickhouse-regression <https://github.com/altinity/clickhouse-regression>`_ project:

.. image:: https://raw.githubusercontent.com/testflows/runners/master/docs/images/embedded-monitoring-dashboard.gif
   :align: center
   :width: 790px
   :alt: Embedded Monitoring Dashboard

See `Embedded Monitoring Dashboard <https://github.com/testflows/runners/wiki/Embedded-Monitoring-Dashboard>`_ for more details.
...
.. _Config class: https://github.com/testflows/runners/blob/main/testflows/github/runners/config.py#L45
